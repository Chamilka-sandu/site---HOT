...
const PotteryDetails = () => {
  ...
  const [potteryDetails, setPotteryDetails] = useState(null);
  ...
  useEffect(async () => {
    ...
    if (docSnap.exists()) setPotteryDetails(docSnap.data());
    else setPotteryDetails(null);
      ...
      <div class="col-md-10 mx-auto" style={{paddingtop: '30px'}}>
        <div class="media align-items-end profile-head">
          <div class="profile mr-6" >
            ...
            <br></br>
            <div class="px-4 py-3">
          <h4 class="mb-0">Since {potteryDetails.since}</h4>
          </div>
          </div>
              ...
              <div class="col-lg-3 col-md-3" >
                <div class="card-body d-flex align-items-center c-detail pl-0">
                  ...
                  <div class="ms-4" >
                    ...
                    <p class="">{potteryDetails.address}</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-2 col-md-2" ></div>
              ...
              <div class="card-body d-flex align-items-center c-detail pl-0">
                <div class="mr-6 align-self-center" style={{marginTop:'25px'}}>
                  ...
                  <div class="ms-4">
                    ...
                    <p class="">{potteryDetails.phone}</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-2 col-md-2" ></div>
              <GoogleMapComponent
        lat={potteryDetails.location._lat}
        long={potteryDetails.location._long}
      />
            </div>
          </div>
